...
import com.cafe.service.RelatorioOutrasDespesasCusteioService;
...
@Named
@ViewScoped
public class RelatorioOutrasDespesasCusteioBean implements Serializable {
	...
	@Inject
	private RelatorioOutrasDespesasCusteioService relatorioService;
